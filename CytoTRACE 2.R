...
pdf("E:/B_group/cytoTRACE/Hepatocytes/cytotrace2_4.pdf", width = 12, height = 12)
(p1+p2+p3+p4) + plot_layout(ncol = 2)
dev.off()

pdf("E:/B_group/cytoTRACE/Hepatocytes/cytotrace2.pdf", width = 5, height = 5)
...
pdf("E:/B_group/cytoTRACE/Hepatocytes/cytotrace2_5.pdf", width = 8, height = 5)
